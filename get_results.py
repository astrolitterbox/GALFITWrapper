...
for califa_id in range(1, 9):
  ...
  data = califa_id, "CALIFA"+str(califa_id).zfill(3), ra1, ra_err1,  dec1, dec_err1, rmag1, rmag1_err, r1e, r1err, n1, n1err, ba1, ba1err, pa1, pa1_err, ra2, ra_err2,  dec2, dec_err2, rmag2, rmag2_err, r2e, r2err, n2, n2err, ba2, ba2err, pa2, pa2_err, sky, sky_err, sky_ygrad, sky_ygrad_err, sky_xgrad, sky_xgrad_err, reduced_Chi2, flags
